...
import com.translator.bestlanguagestranslatorapp.R;


public class Ocr_Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ocrTranslateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Ocr_Act.this, TranslateAct.class);
...
//
//            mAdManagerInterstitialAd.show(Ocr_Act.this);
//
//            mAdManagerInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
//                @Override
//                public void onAdDismissedFullScreenContent() {
//                    Ocr_Act.super.onBackPressed();
//
